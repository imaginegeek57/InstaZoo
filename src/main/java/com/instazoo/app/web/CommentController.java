...
import com.instazoo.app.facade.CommentFacade;
import com.instazoo.app.payload.response.MessageResponse;
import com.instazoo.app.service.CommentService;
...
public class CommentController {
    ...
    public ResponseEntity<List<CommentDTO>> getAllCommentsToPost(@PathVariable("postId") String postId) {
        List<CommentDTO> commentDTOList = commentService.getAllComments(Long.parseLong(postId))
                .stream()
